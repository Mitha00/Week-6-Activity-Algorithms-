...
#Splitting data set into traning and testing.
...
## With an accuracy of 95.6%, this model can be evaluated to have performed well 

#TASK: What percent of cases were correctly classified?
##95.6% of cases were correctly classified
